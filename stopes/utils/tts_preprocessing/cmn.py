...
# Modified from https://github.com/speechio/chinese_text_normalization/blob/master/python/cn_tn.py
# Authors:
...
# Punctuation information based on the Zhon project (https://github.com/tsroten/zhon.git)
CHINESE_PUNC_STOP = "！？｡。"
