...
# Additionally, it is licensed under the MIT license found in the LICENSE file in the current directory.
# This code has been adapted from the Urdu Hack repository:
# https://github.com/urduhack/urduhack/blob/master/urduhack/tokenization/eos.py
...
def urdu_sentence_tokenizer(text: str) -> List[str]:
